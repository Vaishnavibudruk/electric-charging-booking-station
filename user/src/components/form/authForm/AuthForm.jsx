  ...
  return (
    ...
    >
      <div className="row w-75 h-75 shadow-lg">
        {/* Left Column: Image */}
        <div
          className={`col-lg-7 d-none d-lg-block bg-dark p-0 ${styles.authLeftCol} ${styles.evImageAnimation}`}
        >
          <img
            src={AppAssets.loginPageImg5}
            alt="Login"
          ...
          <div className={`${styleFormDiv} ${styles.formWrapper}`}>
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="d-flex align-items-center justify-content-center gap-3">
                <button type="submit" className={styles.evPrimaryButton}>
                  {buttonText}
                </button>
